...
from abacusSoftware.menuBar import AboutMeWindow
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.AboutMeButton.setMaximumSize(QtCore.QSize(140, 60))
        layout2.addWidget(self.AboutMeButton)
        line = QFrame()
        ...
        self.AboutMeButton.clicked.connect(self.aboutMeAction)
        ...
        self.aboutMe_window = AboutMeWindow()
    ...
    def aboutMeAction(self):
        self.aboutMe_window.show()
